...
MODULE_PERMS = {
    ...
    "bio_dezynfekcja": {"read": [ROLE_ADMIN, ROLE_USER], "write": [ROLE_ADMIN, ROLE_USER]},
    "bio_biobojcze": {"read": [ROLE_ADMIN, ROLE_USER], "write": [ROLE_ADMIN, ROLE_USER]},
    "bio_maty": {"read": [ROLE_ADMIN, ROLE_USER], "write": [ROLE_ADMIN, ROLE_USER]},
    "bio_przeglady": {"read": [ROLE_ADMIN, ROLE_USER], "write": [ROLE_ADMIN, ROLE_USER]},
    "bio_insekty": {"read": [ROLE_ADMIN, ROLE_USER], "write": [ROLE_ADMIN, ROLE_USER]},
    "bio_transport": {"read": [ROLE_ADMIN, ROLE_USER], "write": [ROLE_ADMIN, ROLE_USER]},
    "bio_derat_biogaz": {"read": [ROLE_ADMIN, ROLE_USER], "write": [ROLE_ADMIN, ROLE_USER]},
    "bio_deratyzacja": {"read": [ROLE_ADMIN, ROLE_USER], "write": [ROLE_ADMIN, ROLE_USER]},
}
